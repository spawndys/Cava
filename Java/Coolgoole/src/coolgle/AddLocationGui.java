...
** Decription- * Loads the AdLocation Screen. 
 * Handles these cases : 
...
public class AddLocationGui extends javax.swing.JFrame 
{
     ...
     * pre 
     * post adds location to filesystem and gui
     */
    ...
    /**This will be used with the modify location screen,
     * Creates new form AddLocation
     * pre admin gui is set up
     * post load the add location screen with the data already pre-filled in.
     */
    ...
    * pre newlocation valid
    * post adds location to filesystem
    * @param newLocation
    */
